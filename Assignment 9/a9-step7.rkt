...
;all instances of (define X (lambda () ...)) have to be
;changed to use (define-label ...)
;need to figure out how this is done

;also, use (define-program-counter X) to
;define the pc register
;this will keep track of where the program needs to return to
