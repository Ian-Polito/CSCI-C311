...
;just remove #lang racket, require parenthec, and save this as interp.pc
...
(define-registers
  ...
  k
  rator
  r2 ;previously rand, needed to rename this, caused errors upon compilation
  v
  vari)
