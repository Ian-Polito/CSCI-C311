...
void *ktr_appr__m__outerr__m__k(void *envr__m__cps, void *rr2, void *k) {
kt* _data = (kt*)malloc(sizeof(kt));
if(!_data) {
  fprintf(stderr, "Out of memory\n");
  exit(1);
  ...
  _data->u._appr__m__outerr__m__k._rr2 = rr2;
...
void *exprr_app(void *rator, void *rr2) {
expr* _data = (expr*)malloc(sizeof(expr));
if(!_data) {
  fprintf(stderr, "Out of memory\n");
  exit(1);
...
exp = (void *)body;
env = (void *)envrr_extendr__m__env(rr2,envr__m__cps);
pc = &valuer__m__ofr__m__cps;
break; }
}
}
...
void *rr2 = _c->u._appr__m__outerr__m__k._rr2;
...
void *rr2 = _c->u._app._rr2;
exp = (void *)rator;
k = (void *)ktr_appr__m__outerr__m__k(env,rr2,k);
pc = &valuer__m__ofr__m__cps;
break; }
}
}
